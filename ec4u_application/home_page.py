...
root.iconbitmap(r"components/Hello.ico")
...
img_title = ImageTk.PhotoImage(Image.open("components/topicon_EC4U.png"))
...
def active_txt(event):
    txt_display.config(highlightbackground = "#7b3f00", highlightcolor= "#7b3f00")
...
while(True):
    ...
    roi = cv2.rectangle(frame, (320, 10), (610, 290), (123, 63, 0), 2)
    ...
    if(predict_final != 'BLANK' and score_final >= 57):
